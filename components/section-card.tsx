    ...
    <>
      <Card
        className={cn(
          ...
          "hover:shadow-lg hover:shadow-[#4A9EFF]/10 relative border border-slate-800/50",
      ...
      >
        ...
        <CardContent
          className={cn(
            ...
            scrollable
              ? "max-h-[400px] overflow-y-auto scrollbar-thin scrollbar-thumb-slate-700/50 scrollbar-track-transparent"
              : ""
          )}
        >
          {children}
